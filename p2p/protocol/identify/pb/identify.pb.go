...
type Identify struct {
	...
	// see github.com/riteshRcH/go-edge-device-lib-core/record/pb/envelope.proto and
	// github.com/riteshRcH/go-edge-device-lib-core/peer/pb/peer_record.proto for message definitions.
