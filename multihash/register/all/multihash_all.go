/*
	...
	It is meant to be used as a side-effecting import, e.g.
		...
		import (
			_ ""github.com/riteshRcH/go-edge-device-lib/multihash/register/all"
		)
...
import (
	_ "github.com/riteshRcH/go-edge-device-lib/multihash/register/blake2"
	_ "github.com/riteshRcH/go-edge-device-lib/multihash/register/blake3"
	_ "github.com/riteshRcH/go-edge-device-lib/multihash/register/murmur3"
	_ "github.com/riteshRcH/go-edge-device-lib/multihash/register/sha3"
)
